...
\newcommand{\figDeepTerrainRL}{
    \begin{figure}[!ht]
        \centering
        \begin{subfigure}[b]{0.7\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_1.png}
            \caption{}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.7\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_2.png}
            \caption{}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.7\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_3.png}
            \caption{}
        \end{subfigure}

        \caption{Agents from \citeauthor{DeepTerrainRL} traversing complicated environments.}
        \label{fig:ch3_deepterrainrl}
    \end{figure}
}

\newcommand{\figDeepTerrainRLcharacterFeatures}{
    \begin{figure}[!ht]
        \centering
        \begin{subfigure}[b]{0.4\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_character_features.png}
            \caption{}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.8\textwidth}
            \centering
            \includegraphics[width=1.0\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_terrain_features.png}
            \caption{}
        \end{subfigure}

        \caption{State representation for the agent. 
                    a) Character features from agent's bodies. 
                    b) Terrain features from the terrain ahead of the agent.}
        \label{fig:ch3_deepterrainrl_state_features}
    \end{figure}
}

\newcommand{\figDeepTerrainRLMACE}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.5\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_mace.png}
        \caption{Mixture of Actors and Critics Experts (MACE). This approach uses various
                 actor policies, which are used according to the decisions given by
                 the critics networks. Extracted from \href{https://youtu.be/8qQmL3f2fd8?t=312}{here}.}
        \label{fig:ch3_deepterrainrl_mace}
    \end{figure}
}

\newcommand{\figDeepTerrainRLArchitecture}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.8\textwidth]{./chapters/chapter_3/imgs/img_ch3_deepterrainrl_network_architecture.png}
        \caption{Network architecture used by the agents \cite{DeepTerrainRL}. Actors and critics share various weights
                 between them.}
        \label{fig:ch3_deepterrainrl_architecture}
    \end{figure}
}

\newcommand{\figDeepLocoTasks}{
    \begin{figure}[!ht]
        \centering
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=1.0\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_tasks_1.png}
            \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=1.0\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_tasks_2.png}
            \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=1.0\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_tasks_3.png}
            \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=1.0\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_tasks_4.png}
            \caption{}
        \end{subfigure}
        \caption{Tasks presented in \cite{DeepLoco}. a) Path navigation. b) Soccer dribbling.
                 c) Terrain traversal with static obstacles. d) Terrain traversal with dynamic obstacles.}
        \label{fig:ch3_deeploco_tasks}
    \end{figure}
}

\newcommand{\figDeepLocoSystem}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.5\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_system.png}
        \caption{Overview of the system presented in \cite{DeepLoco}. It consists
                 two-level hierarchical controller.}
        \label{fig:ch3_deeploco_system}
    \end{figure}
}

\newcommand{\figDeepLocoStateFeatures}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.6\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_state_features.png}
        \caption{State representation used in \cite{DeepLoco}}
        \label{fig:ch3_deeploco_state_features}
    \end{figure}
}

\newcommand{\figDeepLocoArchitectures}{
    \begin{figure}[!ht]
        \centering
        \begin{subfigure}[b]{0.8\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_network_hlc.png}
            \caption{}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.8\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_network_llc.png}
            \caption{}
        \end{subfigure}

        \caption{Network architectures used for the high and low level controllers.}
        \label{fig:ch3_deeploco_architectures}
    \end{figure}
}

\newcommand{\figEmergenceOfLocomotionTasks}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.95\textwidth]{./chapters/chapter_3/imgs/img_ch3_emergence_of_locomotion_tasks.png}
        \caption{Agent from \cite{DeepmindEmergenceLocomotion} traversing obstacle course.}
        \label{fig:ch3_emergence_of_locomotion_tasks}
    \end{figure}
}

\newcommand{\figEmergenceOfLocomotionStateRepresentation}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.6\textwidth]{./chapters/chapter_3/imgs/img_ch3_emergence_of_locomotion_state_representation.png}
        \caption{State representation used for the agents in \cite{DeepmindEmergenceLocomotion}}
        \label{fig:ch3_emergence_of_locomotion_state_representation}.
    \end{figure}
}

\newcommand{\figEmergenceOfLocomotionTerrain}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.8\textwidth]{./chapters/chapter_3/imgs/img_ch3_emergence_of_locomotion_terrains.png}
        \caption{Terrain types used in \cite{DeepmindEmergenceLocomotion}. These were
                 procedurally generated and the difficulty was increased using a curriculum.}
        \label{fig:ch3_emergence_of_locomotion_terrains}
    \end{figure}
}
