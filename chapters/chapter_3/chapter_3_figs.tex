...
\newcommand{\figDeepTerrainRLArchitecture}{
    \begin{figure}[!ht]
        ...
        \caption{Network architecture used by the agents. Actors and critics share various weights
                 between them.}
...
\newcommand{\figDeepLocoStateFeatures}{
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=0.5\textwidth]{./chapters/chapter_3/imgs/img_ch3_deeploco_state_features.png}
