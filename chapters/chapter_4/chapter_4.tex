...
\begin{itemize}
    \item Details of the approach, where we discuss some core ideas of the proposal.
    \item Details of the proposed framework, where we discuss the core functionality 
          of the framework, the architecture to be used, and the scope of the framework.
    \item Details of the evaluation experiments, where we discuss the proposed experiments
          that will be implemented as part of the proposed evaluation.
\end{itemize}
