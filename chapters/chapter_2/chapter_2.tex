...
is intractable, thus we make use of a mathematical trick (REINFORCE trick) to get an estimate of this gradient [@CITE-sutton-2000]. \todo{en vez de so, usa thus, es más formal}
