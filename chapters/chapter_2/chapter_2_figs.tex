...
\newcommand{\figPhysicsEngineLoop}{
    \begin{figure}
        ...
        \caption{A common pipeline used by physics engines, from [@CITE-mlcp]}
...
\newcommand{\figActuationModels}{
    \begin{figure}
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_2/imgs/img_actuation_torque.png}
            \caption{}
            \label{fig:ch2_actuation_torques}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_2/imgs/img_actuation_target_velocities.png}
            \caption{}
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_2/imgs/img_actuation_target_angles.png}
            \caption{}
            \label{fig:ch2_actuation_target_angles}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{./chapters/chapter_2/imgs/img_actuation_muscle_activation.png}
            \caption{}
